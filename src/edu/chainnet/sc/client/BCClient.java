...
class BCClient
{
	...
	{
		Response res = (Response)StandaloneClient.CS().read(this.collaboratorAddress.getIP(), this.collaboratorAddress.getPort(), new RetrieveBCNodeUponIDRequest(NodeInfo.BC().getBCID()));
	...
	{
		Response res = (Response)StandaloneClient.CS().read(this.collaboratorAddress.getIP(), this.collaboratorAddress.getPort(), new RetrieveDLNodeUponIDRequest(NodeInfo.BC().getDLID()));
	...
	{
		Response res = (Response)StandaloneClient.CS().read(this.collaboratorAddress.getIP(), this.collaboratorAddress.getPort(), new RetrieveONNodeUponIDRequest(NodeInfo.BC().getONID()));
	...
	{
		Response res = (Response)StandaloneClient.CS().read(this.collaboratorAddress.getIP(), this.collaboratorAddress.getPort(), new RetrieveSCNodeUponIDRequest(NodeInfo.BC().getSCID()));
