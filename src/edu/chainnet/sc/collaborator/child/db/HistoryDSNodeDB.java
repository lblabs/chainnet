...
class HistoryDSNodeDB
{
	...
	public DSNode getNode(String nodeKey, int version, int nodeType)
	{
		HistoryDSNodeEntity entity = this.accessor.getPrimaryKey().get(DBConfig.getHistoryDSKey(nodeKey, version, nodeType));
		if (entity != null)
		{
	...
	public int getVersionSize(String nodeKey, int nodeType)
	{
		...
		SecondaryIndex<String, String, HistoryDSNodeEntity> sIndex = this.env.getEntityStore().getSecondaryIndex(primaryIndex, String.class, DBConfig.NODE_KEY);
