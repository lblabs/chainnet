...
class HistoryBCNodeEntity
{
	...
	public HistoryBCNodeEntity(String key, String nodeKey, int version, String name, String ip, int port, String serviceName, List<String> partners, String description)
	{
		this.key = key;
