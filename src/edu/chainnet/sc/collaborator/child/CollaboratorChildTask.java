	...
	public void processNotification(Notification notification)
	{
		...
		switch (notification.getApplicationID())
		{
			case SCAppID.SYNCHRONIZE_BLOCK_CHAIN_NODE_REGISTRY_NOTIFICATION:
				...
				currentBCNode = CollaboratorDB.BC().getBCNodeByKey(sbcnrn.getKey());
			...
			case SCAppID.SYNCHRONIZE_SMART_CONTRACT_NODE_REGISTRY_NOTIFICATION:
				...
				currentDSNode = CollaboratorDB.BC().getDSNodeByKey(sccnrn.getKey());
			...
			case SCAppID.SYNCHRONIZE_ORACLE_NODE_REGISTRY_NOTIFICATION:
				...
				currentDSNode = CollaboratorDB.BC().getDSNodeByKey(sonnrn.getKey());
				if (currentDSNode != null)
				{
			...
			case SCAppID.SYNCHRONIZE_DATA_LAKE_NODE_REGISTRY_NOTIFICATION:
				...
				currentDSNode = CollaboratorDB.BC().getDSNodeByKey(sdlnrn.getKey());
				if (currentDSNode != null)
				{
	...
	public MulticastResponse processRequest(Request request)
	{
		switch (request.getApplicationID())
		{
			...
			case SCAppID.RETRIEVE_BC_NODE_UPON_ID_REQUEST:
				...
				return new RetrieveBCNodeUponIDResponse(CollaboratorDB.BC().getBCNodeByKey(bnidr.getNodeKey()), bnidr.getCollaboratorKey());
			...
			case SCAppID.RETRIEVE_DL_NODE_UPON_ID_REQUEST:
				...
				return new RetrieveDLNodeUponIDResponse(CollaboratorDB.BC().getDSNodeByKey(dnidr.getNodeKey()), dnidr.getCollaboratorKey());
			...
			case SCAppID.RETRIEVE_ON_NODE_UPON_ID_REQUEST:
				...
				return new RetrieveONNodeUponIDResponse(CollaboratorDB.BC().getDSNodeByKey(onidr.getNodeKey()), onidr.getCollaboratorKey());
			...
			case SCAppID.RETRIEVE_SC_NODE_UPON_ID_REQUEST:
				...
				return new RetrieveSCNodeUponIDResponse(CollaboratorDB.BC().getDSNodeByKey(scidr.getNodeKey()), scidr.getCollaboratorKey());
