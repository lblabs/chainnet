...
class Paths
{
	...
	public synchronized ChildPath getPath()
	{
		...
		else
		{
			...
			String dsPath = DBConfig.DB_HOME + childID + UtilConfig.FORWARD_SLASH + DBConfig.DSNODE_DB_PATH;
			log.info("dsPath = " + dsPath);
			String historyBCPath = DBConfig.DB_HOME + childID + UtilConfig.FORWARD_SLASH + DBConfig.HISTORY_BCNODE_DB_PATH;
			log.info("historyBCPath = " + historyBCPath);
			String historyDSPath = DBConfig.DB_HOME + childID + UtilConfig.FORWARD_SLASH + DBConfig.HISTORY_DSNODE_DB_PATH;
